...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            {
...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
        ...
        {
#line 17 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            foreach (var numQubits in new QRange(3L, 8L))
#line hidden
            {
#line hidden
                {
#line 18 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    var (input,output) = (Allocate__.Apply(numQubits), Allocate__.Apply());
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 19 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, input));
#line 20 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        Microsoft__Quantum__Intrinsic__X.Apply(output);
#line 22 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        Lab5__Exercise1.Apply((input, output));
#line 24 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        foreach (var qubit in input)
#line hidden
                        {
#line 25 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Intrinsic__Z.Controlled.Apply((new QArray<Qubit>(qubit), output));
                        }

#line 27 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        Microsoft__Quantum__Intrinsic__X.Apply(output);
#line 28 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, input));
#line 30 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs", OperationFunctor.Body, 36, 61)]
...
#line 36 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 36 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 37 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 38 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                foreach (var numQubits in new QRange(3L, 8L))
#line hidden
                {
#line hidden
                    {
#line 39 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        var (input,output) = (Allocate__.Apply(numQubits), Allocate__.Apply());
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 40 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            var firstIndex = Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, (numQubits - 1L)));
#line 41 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            var temp = Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, (numQubits - 2L)));
#line 42 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            var secondIndex = ((firstIndex != temp) ? temp : (temp + 1L));
#line 44 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, input));
#line 45 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Intrinsic__X.Apply(output);
#line 47 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Lab5__Exercise2.Apply((firstIndex, secondIndex, input, output));
#line 49 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Intrinsic__Z.Controlled.Apply((new QArray<Qubit>(input[firstIndex]), output));
#line 50 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Intrinsic__Z.Controlled.Apply((new QArray<Qubit>(input[secondIndex]), output));
#line 51 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Intrinsic__X.Apply(output);
#line 52 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, input));
#line 54 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                            Microsoft__Quantum__Diagnostics__AssertAllZero.Apply(QArray<Qubit>.Add(input, new QArray<Qubit>(output)));
                        }
#line hidden
                        catch
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs", OperationFunctor.Body, 61, -1)]
...
#line 61 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 61 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 62 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
            foreach (var i in new QRange(0L, 10L))
#line hidden
            {
#line 63 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                foreach (var numQubits in new QRange(3L, 8L))
#line hidden
                {
#line 64 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    var firstIndex = Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, (numQubits - 1L)));
#line 65 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    var temp = Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, (numQubits - 2L)));
#line 66 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    var secondIndex = ((firstIndex != temp) ? temp : (temp + 1L));
#line 68 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    if ((Lab5__Exercise3.Apply((numQubits, Lab5__AlwaysZero)) == false))
                    {
#line 69 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        throw new ExecutionFailException("Incorrectly classified AlwaysZero as balanced.");
                    }

#line 72 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    if ((Lab5__Exercise3.Apply((numQubits, Lab5__AlwaysOne)) == false))
                    {
#line 73 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        throw new ExecutionFailException("Incorrectly classified AlwaysOne as balanced.");
                    }

#line 76 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    if ((Lab5__Exercise3.Apply((numQubits, Lab5__Exercise1)) == true))
                    {
#line 77 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                        throw new ExecutionFailException("Incorrectly classified Exercise1 as constant.");
                    }

#line 80 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
                    ...
                    {
#line 84 "/home/ace/scripts/quantum/QSharpExercises/Lab5/Lab5Tests.qs"
