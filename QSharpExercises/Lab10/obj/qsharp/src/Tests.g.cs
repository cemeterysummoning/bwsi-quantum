...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            {
...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
        ...
        {
#line 17 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            foreach (var i in new QRange(1L, 25L))
#line hidden
            {
#line hidden
                {
#line 18 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                    var (original,spares) = (Allocate__.Apply(), Allocate__.Apply(2L));
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 19 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        var rotation = (IQArray<Double>)Tests__Utils__GenerateRandomRotation.Apply(QVoid.Instance);
#line 20 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        Tests__Utils__ApplyRotation.Apply((rotation, original));
#line 22 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        Lab10__Exercise1.Apply((original, spares));
#line 24 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        Microsoft__Quantum__Intrinsic__CNOT.Apply((original, spares[0L]));
#line 25 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        Microsoft__Quantum__Intrinsic__CNOT.Apply((original, spares[1L]));
#line 26 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        Tests__Utils__ApplyRotation.Adjoint.Apply((rotation, original));
#line 28 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs", OperationFunctor.Body, 34, 92)]
...
#line 34 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 34 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 35 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 36 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                foreach (var brokenQubitIndex in new QRange(-(1L), 3L))
#line hidden
                {
#line hidden
                    {
#line 37 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        var register = Allocate__.Apply(3L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 38 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            var rotation = (IQArray<Double>)Tests__Utils__GenerateRandomRotation.Apply(QVoid.Instance);
#line 39 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Tests__Utils__ApplyRotation.Apply((rotation, register[0L]));
#line 40 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Lab10__Exercise1.Apply((register[0L], register.Slice(new QRange(1L, 2L))));
#line 43 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            if ((brokenQubitIndex == -(1L)))
                            {
#line 44 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                var syndrome = new QArray<Result>(Lab10__Exercise2.Apply(register));
#line 45 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                if (((syndrome[0L] != Result.Zero) || (syndrome[1L] != Result.Zero)))
                                {
#line 46 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            ...
                            {
#line 54 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(register[0L]);
#line 55 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                var syndrome = new QArray<Result>(Lab10__Exercise2.Apply(register));
#line 56 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                if (((syndrome[0L] != Result.One) || (syndrome[1L] != Result.One)))
                                {
#line 57 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            ...
                            {
#line 65 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(register[1L]);
#line 66 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                var syndrome = new QArray<Result>(Lab10__Exercise2.Apply(register));
#line 67 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                if (((syndrome[0L] != Result.One) || (syndrome[1L] != Result.Zero)))
                                {
#line 68 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            ...
                            {
#line 76 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(register[2L]);
#line 77 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                var syndrome = new QArray<Result>(Lab10__Exercise2.Apply(register));
#line 78 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                if (((syndrome[0L] != Result.Zero) || (syndrome[1L] != Result.One)))
                                {
#line 79 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
...
#line 85 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs", OperationFunctor.Body, 92, -1)]
...
#line 92 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 92 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 93 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 94 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                foreach (var brokenQubitIndex in new QRange(-(1L), 2L))
#line hidden
                {
#line hidden
                    {
#line 95 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                        var register = Allocate__.Apply(3L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 96 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            var rotation = (IQArray<Double>)Tests__Utils__GenerateRandomRotation.Apply(QVoid.Instance);
#line 97 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Tests__Utils__ApplyRotation.Apply((rotation, register[0L]));
#line 98 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Lab10__Exercise1.Apply((register[0L], register.Slice(new QRange(1L, 2L))));
#line 100 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            if ((brokenQubitIndex >= 0L))
                            {
#line 101 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(register[brokenQubitIndex]);
                            }

#line 104 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            var syndrome = (IQArray<Result>)Lab10__Exercise2.Apply(register);
#line 106 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Lab10__Exercise3.Apply((register, syndrome));
#line 108 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Lab10__Exercise1.Adjoint.Apply((register[0L], register.Slice(new QRange(1L, 2L))));
#line 109 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
                            Tests__Utils__ApplyRotation.Adjoint.Apply((rotation, register[0L]));
#line 111 "/home/ace/scripts/quantum/QSharpExercises/Lab10/Tests.qs"
