...
#line 15 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            {
...
#line hidden
            {
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                var target = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 18 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Lab1__Exercise1.Apply(target);
#line 20 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(target);
#line 22 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs", OperationFunctor.Body, 27, 41)]
...
#line 27 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line hidden
            {
#line 28 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                var targets = Allocate__.Apply(2L);
#line hidden
                bool __arg1__ = true;
                try
                {
#line 30 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Lab1__Exercise2.Apply((targets[0L], targets[1L]));
#line 32 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(targets[0L]);
#line 33 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(targets[1L]);
#line 34 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(targets[1L]);
#line 36 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs", OperationFunctor.Body, 41, 57)]
...
#line 41 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 41 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 42 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            foreach (var numQubits in new QRange(3L, 10L))
#line hidden
            {
#line hidden
                {
#line 43 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    var qubits = Allocate__.Apply(numQubits);
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 45 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                        Lab1__Exercise3.Apply(qubits);
#line 47 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                        foreach (var index in new QRange(0L, (numQubits - 1L)))
#line hidden
                        {
#line 48 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
...
#line 51 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs", OperationFunctor.Body, 57, -1)]
...
#line 57 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 57 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 58 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
            foreach (var i in new QRange(0L, 4L))
#line hidden
            {
#line 59 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                var states = QArray<Int64>.Create(0L);
#line hidden
                {
#line 60 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                    var qubits = Allocate__.Apply(5L);
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 61 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                        foreach (var j in new QRange(0L, 4L))
#line hidden
                        {
#line 62 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                            states = QArray<Int64>.Add(states, new QArray<Int64>(Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, 1L))));
#line 63 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                            if ((states[j] == 1L))
                            {
#line 64 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(qubits[j]);
                            }
                        }

#line 68 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                        var results = (IQArray<Int64>)Lab1__Exercise4.Apply(qubits);
#line 70 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
                        Microsoft__Quantum__Diagnostics__AllEqualityFactI.Apply((states?.Copy(), results, "Exercise 4 test failed."));
#line 71 "/home/ace/scripts/quantum/QSharpExercises/Lab1/Tests.qs"
