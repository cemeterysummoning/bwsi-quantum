...
#line 31 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            foreach (var i in new QRange(0L, (input.Length - 1L)))
#line hidden
            {
#line 32 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs", OperationFunctor.Body, 51, 90)]
    public partial class LeftShiftBy1 : Operation<(IQArray<Qubit>,IQArray<Qubit>), QVoid>, ICallable
    {
        ...
        {
            var (input,output) = __in__;
#line 53 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            foreach (var inputIndex in new QRange(1L, (input.Length - 1L)))
#line hidden
            {
#line 55 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                var outputIndex = (inputIndex - 1L);
#line 56 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs", OperationFunctor.Body, 90, 138)]
...
#line hidden
            {
#line 96 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                var inputsQ = Allocate__.Apply(input.Length);
#line hidden
                bool __arg1__ = true;
                try
                {
#line 97 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                    foreach (var i in new QRange(0L, (input.Length - 1L)))
#line hidden
                    {
#line 98 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                        if (input[i])
                        {
#line 99 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            Microsoft__Quantum__Intrinsic__X.Apply(inputsQ[i]);
                        }
                    }

#line hidden
                    {
#line 102 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                        var outputsQ = Allocate__.Apply(input.Length);
#line hidden
                        bool __arg2__ = true;
                        try
                        {
#line 104 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            var bitstringOut = QArray<Boolean>.Create(input.Length);
#line 106 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            op.Apply((inputsQ, outputsQ));
#line 108 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            foreach (var i in new QRange(0L, (input.Length - 1L)))
#line hidden
                            {
#line 109 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                                var result = Microsoft__Quantum__Intrinsic__M.Apply(outputsQ[i]);
#line 110 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                                bitstringOut.Modify(i, Microsoft__Quantum__Convert__ResultAsBool.Apply(result));
                            }

#line 112 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            ResetAll__.Apply(QArray<Qubit>.Add(inputsQ, outputsQ));
#line 114 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            return bitstringOut;
                        }
#line hidden
                        catch
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs", OperationFunctor.Body, 138, 189)]
...
#line hidden
            {
#line 145 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                var qubits = Allocate__.Apply(inputSize);
#line hidden
                bool __arg1__ = true;
                try
                {
#line hidden
                    {
#line 146 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                        var outputs = Allocate__.Apply(inputSize);
#line hidden
                        bool __arg2__ = true;
                        try
                        {
#line 147 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, qubits));
#line 148 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            op.Apply((qubits, outputs));
#line 149 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, qubits));
#line 151 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            var results = new QArray<Result>(Microsoft__Quantum__Measurement__MeasureEachZ.Apply(qubits));
#line 152 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            ResetAll__.Apply(QArray<Qubit>.Add(qubits, outputs));
#line 153 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
                            return Microsoft__Quantum__Convert__ResultArrayAsBoolArray.Apply(results?.Copy());
                        }
#line hidden
                        catch
                        {
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs", OperationFunctor.Body, 189, 227)]
    public partial class Challenge1 : Operation<(IQArray<Qubit>,IQArray<Qubit>), QVoid>, ICallable
    {
        ...
        {
            var (input,output) = __in__;
#line 192 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            foreach (var i in new QRange(0L, (input.Length - 2L)))
#line hidden
            {
#line 193 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs", OperationFunctor.Body, 227, -1)]
    public partial class Challenge2 : Operation<(IQArray<Qubit>,IQArray<Qubit>), QVoid>, ICallable
    {
        ...
        {
            var (input,output) = __in__;
#line 230 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((input[0L], input[1L]));
#line 231 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__X.Apply(input[1L]);
#line 232 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((input[1L], output[0L]));
#line 233 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((input[2L], output[0L]));
#line 234 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((input[2L], output[1L]));
#line 235 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__X.Apply(input[2L]);
#line 236 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CCNOT.Apply((input[1L], input[2L], output[2L]));
#line 238 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__X.Apply(input[2L]);
#line 239 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__X.Apply(input[1L]);
#line 240 "/home/ace/scripts/quantum/QSharpExercises/Lab7/Lab7.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((input[0L], input[1L]));
#line hidden
            return QVoid.Instance;
        }
