...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
            {
...
#line 16 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
        ...
        {
#line 17 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
...
#line 24 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 25 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                foreach (var buffer in buffers)
#line hidden
                {
#line hidden
                    {
#line 26 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                        var qubits = Allocate__.Apply(2L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 27 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 28 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 30 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Lab4__Exercise1.Apply((buffer, qubits[0L]));
#line 32 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 33 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 35 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
...
#line 40 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
...
#line 46 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
...
#line hidden
    ...
    [SourceLocation("/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs", OperationFunctor.Body, 53, -1)]
...
#line 53 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 53 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 54 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
            var buffers = (IQArray<IQArray<Boolean>>)new QArray<IQArray<Boolean>>(new QArray<Boolean>(false, false), new QArray<Boolean>(false, true), new QArray<Boolean>(true, false), new QArray<Boolean>(true, true));
#line 61 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 62 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                foreach (var buffer in buffers)
#line hidden
                {
#line hidden
                    {
#line 63 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                        var qubits = Allocate__.Apply(2L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 64 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 65 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 66 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            if (buffer[1L])
                            {
#line 67 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(qubits[0L]);
                            }

#line 69 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            if (buffer[0L])
                            {
#line 70 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                                Microsoft__Quantum__Intrinsic__Z.Apply(qubits[0L]);
                            }

#line 73 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            var result = (IQArray<Boolean>)Lab4__Exercise2.Apply((qubits[0L], qubits[1L]));
#line 75 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            Microsoft__Quantum__Diagnostics__AllEqualityFactB.Apply((result, buffer, "Exercise 2 result is incorrect."));
#line 81 "/home/ace/scripts/quantum/QSharpExercises/Lab4/Lab4Tests.qs"
                            ResetAll__.Apply(qubits);
                        }
#line hidden
                        catch
